...
<title>MoonGang - Actualit&eacute;s</title>
<style>
body {
...
<div id="outdiv">
<iframe src="http://www.dofus.com/fr/guilde/jiva/moongang-21000001/actualites" scrolling="no" width="1280px" height="1480px" id="iniframe"></iframe>
</div>
...
function DesactiveContenuIFrame() {
	for (var i=0; i<parent.frames['iniframe'].document.getElementsByTagName("a").length; i++)
parent.frames['iniframe'].document.getElementsByTagName("a")[i].href="#";
}
</script>
</body>
</html>